...
plot(value[2925:3255]~c(2925:3255),type="l",xlab=c("Upstream distance /m"),ylab=c("Elevation /m"),ylim=c(80,86))
...
plot(value[3245:3475]~c(3245:3475),type="l",xlab=c("Upstream distance /m"),ylab=c("Elevation /m"),ylim=c(83,88))
