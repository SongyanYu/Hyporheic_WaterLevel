##This script is used to plot longitudinal profile.
##This is based on Kobble creel 1m DEM data

library(raster)
setwd("H:/My Drive/PhD at GU/Part 3 River channel identification/Kobble Cr")
